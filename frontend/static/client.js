...
Office.onReady((info) => {
    if (info.host === Office.HostType.Word) {
        ...
        } catch(e) { console.error("Error al suscribirse a la selección:", e); }
...
async function startNewChat() {
    ...
    } catch(e) { console.error("Error al crear chat:", e); }
}
...
async function sendMessage() {
    ...
    try {
        ...
        appendMessage("msg-agent", `Error de conexión: ${error.message}`);
    } finally {
        setLoading(false);
